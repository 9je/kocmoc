...
local loadedscript = game:HttpGet("https://raw.githubusercontent.com/9je/kocmoc/main/functions/viciousbeeserverhop.lua")
...
local Cookie = loadstring(game:HttpGet("https://raw.githubusercontent.com/9je/kocmoc/main/functions/auth"))()()
